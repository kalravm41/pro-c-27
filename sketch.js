...
function keyPressed(){
	...
	//	Matter.Body.applyForce(bobobject2.body,bobobject2.body.position,{x:-20,y:-20})
	//	Matter.Body.applyForce(bobobject3.body,bobobject3.body.position,{x:-20,y:-20})
	//	Matter.Body.applyForce(bobobject4.body,bobobject4.body.position,{x:-20,y:-20})
